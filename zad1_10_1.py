...
class Game(Problem):
    ...
    def is_allowed(self, state):
        x, y = state
        if 0 <= x < 10 and 0 <= y < 10 and state not in self.crveni:
            return True
        return False
    def successor(self, state):
        #print(state)
        ...
        if direction == "dolu":
            #print(state)
            state1 = (x, y - 1)
            if self.is_allowed(state1) and  state1 not in snake:
                if state1 in apples:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['ProdolzhiPravo'] = (r, direction, apples1)
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['ProdolzhiPravo'] = (r, direction, apples)
            state1 = (x + 1, y)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    list1 = list(snake)
                    list1.append(state1)
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiLevo'] = (r, "desno", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiLevo'] = (r, "desno", apples1)
            state1 = (x - 1, y)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    list1 = list(snake)
                    ...
                    list1.append(state1)
                    r = tuple(list1)
                    neighbours['SvrtiDesno'] = (r, "levo", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiDesno'] = (r, "levo", apples1)
        elif direction == "gore":
            state1 = (x, y + 1)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
            ...
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiDesno'] = (r, "desno", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiDesno'] = (r, "desno", apples1)
            state1 = (x - 1, y)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    list1 = list(snake)
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiLevo'] = (r, "levo", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiLevo'] = (r, "levo", apples1)
            ...
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiDesno'] = (r, "dolu", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiDesno'] = (r, "dolu", apples1)
            state1 = (x, y + 1)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    list1 = list(snake)
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiLevo'] = (r, "gore", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiLevo'] = (r, "gore", apples1)
        elif direction == "levo":
            state1 = (x - 1, y)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 in apples:
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['ProdolzhiPravo'] = (r, "levo", apples1)
                else:
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['ProdolzhiPravo'] = (r, "levo", apples)
            state1 = (x, y + 1)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    list1 = list(snake)
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiDesno'] = (r, "gore", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiDesno'] = (r, "gore", apples1)
            state1 = (x, y - 1)
            if self.is_allowed(state1) and state1 not in snake:
                if state1 not in apples:
                    list1 = list(snake)
                    ...
                    list1.pop(0)
                    r = tuple(list1)
                    neighbours['SvrtiLevo'] = (r, "dolu", apples)
                else:
                    list1 = list(snake)
                    list1.append(state1)
                    r = tuple(list1)
                    ...
                    listA.remove(state1)
                    apples1 = tuple(listA)
                    neighbours['SvrtiLevo'] = (r, "dolu", apples1)
        #print(neighbours)
        return neighbours
...
if __name__ == '__main__':
    ...
    zeleni_jabolki = []
    for i in range(nC):
        zeleni_jabolki.append(tuple(map(int, input().split(","))))
    nZ = int(input())
    for i in range(nZ):
        crveni_jabolki.append(tuple(map(int, input().split(","))))
    zmija = ((0, 9), (0, 8), (0, 7))
    pravec = "dolu"
    init = (zmija, pravec, tuple(zeleni_jabolki))
    problem = Game(init, crveni_jabolki)
