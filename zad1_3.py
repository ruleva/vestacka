...
class Pillars(Problem):
    ...
    def goal_test(self, state):
        ...
        state1 = []
        for g in state:
            state1.append(tuple(self.cut_empty(list(g))))
        goal1=[]
        for g in self.goal:
            goal1.append(tuple(self.cut_empty(g)))
        # print(state1)
        # print(goal1)
        # print("*")
        return tuple(state1) == tuple(goal1)
    ...
    def cut_empty(self,list1):
        list12=[]
        #print(list1)
        for i in range(len(list1)):
            if list1[i] != '':
                list12.append(int(list1[i]))
        return list12
        ...
        for i in range(len(state)):
            ...
            for j in range(len(state)):
                if i != j:
                    ...
                    if len(pillari1) > 0:
                        if pillari1[0] != '':
                            # print(len(pillari1) - 1)
                            top_block1 = int(pillari1[0])
                        else:
                            top_block1 = -1
                    if top_block != 0 and top_block >= top_block1:
                        #print(pillari)
                        #print(top_block)
                        i_pillar=pillari[1:]
                        #print(i_pillar)
                        j_pillar = list(pillari1)
                        j_pillar.insert(0,top_block)
                        #print(j_pillar)
                        new_state = []
                        for k in range(len(state)):
                            if k == i:

                                new_state.append(tuple(self.cut_empty(i_pillar)))
                            elif k == j:
                                new_state.append(tuple(self.cut_empty(j_pillar)))
                            else:
...
if __name__ == "__main__":
    ...
    start1 = []
    for s in start:
        start1.append(tuple(s.split(',')))

    end1 = []
    for e in end:
        end1.append(tuple(e.split(',')))

    problem = Pillars(tuple(start1), tuple(end1))
